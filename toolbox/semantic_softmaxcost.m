function [cost,grad] = semantic_softmaxcost(theta,lambda, gamma, x_train, y_train,yx, gt_label)
% 
...
y_proto = unique(y_train','rows','stable');
y_proto = y_proto';
...
thetagrad = -1/numClasses * y_proto * (gt_label-p) * x_train' + lambda * theta + gamma * y_proto *  Alpha- gamma* yx;
%- gamma* yx
%  
grad = [thetagrad(:)];
